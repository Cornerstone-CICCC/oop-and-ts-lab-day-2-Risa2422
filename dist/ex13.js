...
function InjectTimestamp(target, context) {
...
let Report1 = (() => {
    let _classDecorators = [InjectTimestamp];
    ...
    var Report1 = class {
        ...
        static {
            ...
            Report1 = _classThis = _classDescriptor.value;
    ...
    return Report1 = _classThis;
})();
// Expected output (when creating a new instance):
const report = new Report1("Quarterly Report");
